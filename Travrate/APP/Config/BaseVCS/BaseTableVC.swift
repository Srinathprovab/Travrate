    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let cellType = data?.cellType {
            ...
            case .AddDeatilsOfPassengerTVCell :
                let cell: AddDeatilsOfPassengerTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .AddPassengerButtonTVCell :
                let cell: AddPassengerButtonTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .TransferfareSummeryTVCell :
                let cell: TransferfareSummeryTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                commonCell = cell
                
                
            case .ActivitiesSearchTVCell :
                let cell: ActivitiesSearchTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .ActivitiesResultTVCell :
                let cell: ActivitiesResultTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .ActivitiesImagesTVCell :
                let cell: ActivitiesImagesTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .ContractRemarkTVCell :
                let cell: ContractRemarkTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
            case .PopularHotelDestinationsTVCell :
                let cell: PopularHotelDestinationsTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .BDPickupLocationTVCell :
                let cell: BDPickupLocationTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .CruiseTermsTVCell :
                let cell: CruiseTermsTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .FlightTripsTVCell :
                let cell: FlightTripsTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
            ...
            case .NoDataFoundTVCell :
                let cell: NoDataFoundTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                commonCell = cell
                
                
            case .ActivitiesTypeTVCell :
                let cell: ActivitiesTypeTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .ActivitiesHighlightsTVCell :
                let cell: ActivitiesHighlightsTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                commonCell = cell
                
                
            case .ActivitiesDecreptionTVCell :
                let cell: ActivitiesDecreptionTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                commonCell = cell
                
                
                
            case .ActivitiesTypeInfoTVCell :
                let cell: ActivitiesTypeInfoTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
                
                
            case .FlightBookingConfirmedTVCell :
                let cell: FlightBookingConfirmedTVCell = commonTV.dequeTVCell(indexPath: indexPath)
                cell.delegate = self
                commonCell = cell
