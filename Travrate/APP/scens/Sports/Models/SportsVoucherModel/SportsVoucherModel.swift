...
struct SportsVoucherModel : Codable {
    let data : SportsVoucherData?
    let sports_passengers : [Sports_passengers]?
    ...
    init(from decoder: Decoder) throws {
        ...
        data = try values.decodeIfPresent(SportsVoucherData.self, forKey: .data)
        sports_passengers = try values.decodeIfPresent([Sports_passengers].self, forKey: .sports_passengers)
    }
...
struct SportsVoucherData : Codable {
    let id : String?
    ...
    let language : String?
    let ip : String?
    let event_list_data : Event_list_data?
    let delivery_Information : String?
    let carry_To_The_Venue : String?
    let emergency_Hotline : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case ip = "ip"
        case event_list_data = "event_list_data"
        case delivery_Information = "Delivery_Information"
        case carry_To_The_Venue = "Carry_To_The_Venue"
        case emergency_Hotline = "Emergency_Hotline"
    ...
    init(from decoder: Decoder) throws {
        ...
        event_list_data = try values.decodeIfPresent(Event_list_data.self, forKey: .event_list_data)
        delivery_Information = try values.decodeIfPresent(String.self, forKey: .delivery_Information)
        carry_To_The_Venue = try values.decodeIfPresent(String.self, forKey: .carry_To_The_Venue)
        emergency_Hotline = try values.decodeIfPresent(String.self, forKey: .emergency_Hotline)
