...
class DurationSliderTVCell: TableViewCell, TTRangeSliderDelegate {
    ...
    func setupDurationSlider() {
        ...
        if let minDuration = filterModel.minDuration, let maxDuration = filterModel.maxDuration {
...
extension DurationSliderTVCell {
