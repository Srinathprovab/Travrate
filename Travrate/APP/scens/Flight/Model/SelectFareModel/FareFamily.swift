...
struct FareFamily : Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        freturn = try values.decodeIfPresent([FligtsFareReturn].self, forKey: .freturn)
    }
...
struct FligtsFareReturn : Codable {
    ...
    let childs_Base_Price : Int?
    let childs_Tax_Price : Int?
  ...
  //      case fare = "fare"
    ...
    init(from decoder: Decoder) throws {
        ...
        childs_Base_Price = try values.decodeIfPresent(Int.self, forKey: .childs_Base_Price)
        childs_Tax_Price = try values.decodeIfPresent(Int.self, forKey: .childs_Tax_Price)
