...
struct SFSearch_params : Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case v_class_round = "v_class_round"
        case to_loc = "to_loc"
    ...
    init(from decoder: Decoder) throws {
        ...
        v_class_round = try values.decodeIfPresent(String.self, forKey: .v_class_round)
