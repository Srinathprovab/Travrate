...
struct SportsUpcoming : Codable {
    ...
    let language : String?
    let ip : String?
    let participants : [SportsTripsParticipants]?
    let voucher_url : String?
    let sports_passengers : [SportsTripspassengers]?
    ...
    init(from decoder: Decoder) throws {
        ...
        participants = try values.decodeIfPresent([SportsTripsParticipants].self, forKey: .participants)
        voucher_url = try values.decodeIfPresent(String.self, forKey: .voucher_url)
        sports_passengers = try values.decodeIfPresent([SportsTripspassengers].self, forKey: .sports_passengers)
    }
...
struct SportsTripsParticipants : Codable {
