//
//  Flight_trips_Booking_details.swift
//  Travrate
//
...
struct Flight_trips_Booking_details : Codable {
    //    let origin : String?
    //    let xlprofld : String?
    ...
    //    let domain_domain_key : String?
    //    let theme_id : String?
    //    let domain_logo : String?
    //    let booked_date : String?
    let booking_itinerary_details : [Flight_Trips_Booking_itinerary_details]?
    ...
    init(from decoder: Decoder) throws {
        ...
        //        ssr_details = try values.decodeIfPresent(String.self, forKey: .ssr_details)
        ...
        booking_itinerary_details = try values.decodeIfPresent([Flight_Trips_Booking_itinerary_details].self, forKey: .booking_itinerary_details)
