//
//  Flight_Trips_Booking_itinerary_details.swift
//  Travrate
//
...
struct Flight_Trips_Booking_itinerary_details : Codable {
    let origin : String?
    ...
    let airline_contact_num : String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case airline_contact_num = "airline_contact_num"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        baggage_details = try values.decodeIfPresent(String.self, forKey: .baggage_details)
        ...
        airline_contact_num = try values.decodeIfPresent(String.self, forKey: .airline_contact_num)
    }
